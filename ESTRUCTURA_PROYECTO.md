...
- `sistema_admin_eest2.sql` - Schema completo de la base de datos
...
### 📂 **img/** - Imágenes
- `logo-eest2.png` - Logo institucional
...
- `qr_estudiantes.php` - Generación de códigos QR para múltiples estudiantes
- `ver_qr.php` - Visualización individual de código QR
- `imprimir_boletin.php` - Impresión de boletín de notas
