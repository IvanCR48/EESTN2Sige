#!/bin/bash
# Script de backup para Sistema Admin EEST2
...
log "Iniciando backup del Sistema Admin EEST2..."

# Backup de base de datos
log "Realizando backup de base de datos..."
if docker-compose exec -T database mysqldump -u root -p${DB_ROOT_PASSWORD:-SecureRootPassword123!} ${DB_NAME:-sistema_admin_eest2} > $BACKUP_DIR/db_backup_$DATE.sql; then
