...
<section class="equipo-section">
    ...
    <div class="card">
        ...
        <div class="alert alert-info alert-info-equipo">
            ...
            <strong>Información importante:</strong> Al crear secretario o vicedirector se genera una contraseña temporal aleatoria que se muestra una sola vez al finalizar el alta.
            Los <strong>preceptores</strong> se dan de alta en <a href="<?php echo htmlspecialchars(function_exists('app_base_path') ? app_base_path('preceptor.php?action=nuevo') : 'preceptor.php?action=nuevo', ENT_QUOTES, 'UTF-8'); ?>">Gestión de preceptores</a>.
        </div>
        ...
        <form method="POST" class="form-container">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" maxlength="100" placeholder="Ej: director@eest2.edu.ar">
                </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Miembros del Equipo Directivo (<?php echo number_format($total_miembros, 0, ',', '.'); ?>)</h3>
        </div>
        <div class="card-body">
    ...
    <div class="card">
        <div class="card-body text-center equipo-vacio">
            ...
            <h3 class="equipo-vacio__titulo">No hay miembros registrados</h3>
