        ...
        <div class="doc-content">
            ...
            <div class="feature-item">
                ...
                <div class="warning-box">
                    <p><i class="fas fa-exclamation-triangle"></i> Al crear una cuenta o si el administrador resetea tu contraseña con la opción "Forzar cambio de contraseña", serás redirigido de manera automática al formulario <code>change_password_obligatorio.php</code> antes de poder operar en el sistema.</p>
                </div>
            </div>
