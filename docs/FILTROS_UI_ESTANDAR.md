...
- [x] Se migro `notas.php` con compatibilidad funcional.
- [x] Se migro `horarios.php` con compatibilidad funcional.
- [x] Se migro `llamados.php` al helper comun manteniendo UX esperada.
- [x] Se migro `asistencia_virtual.php` al helper comun manteniendo UX esperada.
