...
El **Sistema Administrativo E.E.S.T N°2** es una aplicación web completa y funcional para la **E.E.S.T. N°2 "Educación y Trabajo"** que proporciona una solución integral para la administración escolar, incluyendo gestión de estudiantes, profesores, cursos, notas, horarios, llamados de atención y herramientas administrativas avanzadas.
