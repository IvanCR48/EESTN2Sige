        ...
        if (formAsistencia) {
                ...
                currentSavePromise = fetch('asistencia_virtual.php', {
                    ...
                    .then(function (payload) {
                        if (payload && payload.success) {
                            ...
                            var msg = payload && payload.error ? payload.error : 'No se pudo guardar';
                            setStatus(msg, 'error');
                            return false;
                        }
                    })
                    .catch(function () {
                        setStatus('Error de red al guardar', 'error');
                        return false;
                    })
                    .finally(function () {
                        saveInFlight = false;
            ...
            if (dayNavForm) {
                dayNavForm.addEventListener('submit', function (e) {
                    ...
                    setStatus('Guardando antes de cambiar de día...', 'muted');
                    forzarGuardadoInmediato().then(function (ok) {
                        ...
                        setStatus('No se guardó. Revisá conexión e intentá de nuevo.', 'error');
                    });
                });
            }
        }
            ...
            btn.addEventListener('click', function () {
                ...
                if (details) {
                    ...
                    if (isOpen) {
                        ...
                        btn.querySelector('.btn-text').textContent = 'Ver notas y justificativo';
                        btn.querySelector('i').className = 'fas fa-chevron-down';
                    } else {
                        details.style.display = 'block';
                        btn.classList.add('is-open');
                        btn.querySelector('.btn-text').textContent = 'Ocultar notas y justificativo';
