(function () {
        ...
        fetch(url)
            ...
            .then(function (data) {
                ...
                if (data.profesores && data.profesores.length > 0) {
                    ...
                    optVac.textContent = 'Ningún docente disponible: asigne el curso y la materia en la ficha del profesor (Profesor → cursos/materias). Si el curso no tiene especialidad, igual debe figurar en profesor_curso y profesor_materia para el año vigente.';
    ...
    function cargarMateriasPorCurso(cursoSelect, materiaSelect, profesorSelect, selectedMateriaId, selectedProfesorId) {
        ...
        if (profesorSelect) {
            profesorSelect.innerHTML = '<option value="">Seleccionar profesor (primero selecciona curso y materia)</option>';
        }
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (cursoFiltroSelect && profesorFiltroSelect) {
            const reconstruirFiltroProfesores = function () {
                ...
                profesorSel.innerHTML = '<option value="">Todos los profesores</option>';
