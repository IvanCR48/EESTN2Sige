...
class ConfigurationService extends BaseService
{
    ...
    private function insertarConfiguracionesDefault(): void
    {
        $defaults = [
            // Sistema
            ['clave' => 'sistema.nombre', 'valor' => 'Sistema Administrativo E.E.S.T N°2', 'tipo' => 'string', 'categoria' => 'sistema', 'descripcion' => 'Nombre del sistema'],
            ['clave' => 'sistema.timezone', 'valor' => 'America/Argentina/Buenos_Aires', 'tipo' => 'string', 'categoria' => 'sistema', 'descripcion' => 'Zona horaria del sistema'],
            ['clave' => 'sistema.mantenimiento', 'valor' => '0', 'tipo' => 'boolean', 'categoria' => 'sistema', 'descripcion' => 'Modo mantenimiento activado'],
            ...
            ['clave' => 'notificaciones.email_admin', 'valor' => 'admin@eest2.edu.ar', 'tipo' => 'string', 'categoria' => 'notificaciones', 'descripcion' => 'Email del administrador'],
