...
class AlertService extends BaseService
{
    ...
    private function initializeChannels(): void
    {
        $this->channels = [
            'email' => [
                ...
                'from_email' => $this->getConfig('notificaciones.from_email', 'sistema@eest2.edu.ar'),
                'from_name' => $this->getConfig('notificaciones.from_name', 'Sistema EEST2')
            ],
            'slack' => [
    ...
    private function evaluateCondition(string $condition, array $metrics): bool
    {
        ...
        // Soporte explícito: <variable> <operador> <literal>
    ...
    {
        return [
            '+54-223-123-4567', // Admin principal
            '+54-223-123-4568'  // Director
        ];
    }
