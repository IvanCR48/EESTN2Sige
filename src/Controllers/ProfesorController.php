...
class ProfesorController extends BaseService
{
    ...
    /**
     * POST de ficha del profesor con PRG (profesor_ficha.php).
     *
    ...
    public function procesarPostFichaProfesor(int $profesorId, array $post, bool $puedeEditarAdmin, int $usuarioRegistroId): array
    {
        ...
        $base = 'profesor_ficha.php?id=' . $profesorId;
    ...
    /**
     * Arma listados, mapas y datos auxiliares para la vista profesores.php.
     *
    ...
    /**
     * POST alta/baja con PRG (profesores.php).
     *
     * @param array<string, mixed> $post
     * @return array{
    ...
    public function procesarPostProfesores(array $post, bool $esPreceptor, bool $puedeEliminarProfesor): array
    {
        ...
        if (isset($post['guardar_profesor'])) {
            ...
            try {
                ...
                if (!empty($resultado['success'])) {
                    return [
                        'redirect' => 'profesores.php?success=creado',
                        'error' => '',
                        'action' => null,
                        'form_values' => null,
                    ];
        ...
        try {
            ...
            if (!empty($resultado['success'])) {
                return [
                    'redirect' => 'profesores.php?' . http_build_query([
                        'success' => 'eliminado',
