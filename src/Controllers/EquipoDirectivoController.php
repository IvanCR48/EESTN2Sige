...
/**
 * Orquesta POST/PRG y datos de vista para equipo directivo (equipo.php).
 */
class EquipoDirectivoController extends BaseService
{
     ...
     * @param array{redirect_pagina?: string} $opciones redirect_pagina: equipo.php | preceptor.php tras PRG
     *
    ...
    public function procesarPost(
        ...
        $redirectPagina = (string) ($opciones['redirect_pagina'] ?? 'equipo.php');
        if (!in_array($redirectPagina, ['equipo.php', 'preceptor.php'], true)) {
            $redirectPagina = 'equipo.php';
        }
