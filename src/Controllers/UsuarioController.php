...
/**
 * Controlador para la gestión de usuarios (usuarios.php)
 */
class UsuarioController extends BaseService
{
        ...
        try {
            if ($action === 'save') {
                ...
                return [
                    ...
                    'redirect' => 'usuarios.php?success=' . urlencode("Usuario guardado con éxito.")
                ];
    ...
    public function datosVistaGestion(): array
    {
        $usuariosLista = $this->database->fetchAll("
            SELECT u.id, u.dni, u.nombre, u.apellido, u.email, u.rol, u.activo, u.turno_asignado, u.ultimo_acceso,
                   ed.cargo
            FROM usuarios u
