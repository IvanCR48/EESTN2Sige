...
class HorariosController extends BaseService
{
    ...
    /**
     * Listado enriquecido, catálogos de formulario (con alcance preceptor/docente), diagnóstico y mapas para horarios.php.
     *
    ...
    public function construirVistaSemanalHorariosPorCurso(array $horarios, array $diasSemana): array
    {
        ...
        foreach ($horarios as $horario) {
            $especialidad = !empty($horario['especialidad']) ? (string) $horario['especialidad'] : 'Sin especialidad';
    ...
    /**
     * Diagnóstico de catálogos + mapa profesores por curso (misma lógica que horarios.php).
     *
