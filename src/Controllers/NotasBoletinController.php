...
/**
 * Orquesta POST y vista del boletín (notas.php).
...
class NotasBoletinController extends BaseService
{
    ...
    /**
     * Segmentos de columnas del boletín por materia según filtro de cuatrimestre (vista notas.php).
     *
    ...
    public static function boletinEtiquetaSubcolumna(array $seg): string
    {
        ...
        if ($seg['tipo'] === 'cuatrimestre') {
            return (int) $seg['clave'] === 1 ? '1° Cuat.' : '2° Cuat.';
        }

        return $seg['clave'] === 'avance1' ? 'Avance 1' : 'Avance 2';
    }
    ...
    /**
     * Tabla del boletín lista para iterar en la vista (sin lógica de segmentos en notas.php).
     *
