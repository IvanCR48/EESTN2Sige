...
class LlamadoController extends BaseService
{
    ...
    private const MOTIVOS_REGISTRO = [
        ...
        'Conducta inadecuada en clase',
        'Abandono del aula sin autorización',
        'Vandalismo',
        'Otros',
    ];
    ...
    private function construirRedirectLlamadosTrasPrg(array $queryGet, string $success): string
    {
        ...
        return 'llamados.php?' . http_build_query($params);
    }

    /**
     * POST registrar / eliminar en llamados.php (PRG si tiene éxito).
     *
     * @param array<string, mixed> $post
    ...
    /**
     * Datos completos para la vista llamados.php (selectores, tabla, estadísticas).
     *
     * @param list<int> $preceptorCids
     * @param array<string, mixed> $queryGet
