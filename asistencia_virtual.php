...
// Helpers de vista
$estadosConfig = [
    'Presente'            => ['label' => 'Presente',        'clase' => 'av5--presente',    'icono' => 'fa-check-circle'],
    'Tardanza'            => ['label' => 'Tardanza',         'clase' => 'av5--tardanza',    'icono' => 'fa-clock'],
    'Media falta'         => ['label' => 'Media falta',      'clase' => 'av5--media',       'icono' => 'fa-adjust'],
    'Ausente justificado' => ['label' => 'Justificado',      'clase' => 'av5--justificado', 'icono' => 'fa-file-medical'],
    'Ausente'             => ['label' => 'Ausente',          'clase' => 'av5--ausente',     'icono' => 'fa-times-circle'],
];

$fechaLabel = (function (string $f): string {
    $ts = strtotime($f);
...
<section class="av-section">
    <div class="section-header">
        <h2><i class="fas fa-clipboard-check"></i> Asistencia Virtual</h2>
        <div class="header-actions">
            <a href="asistencia_dashboard.php" class="btn btn-secondary">
    ...
    <div class="alert alert-error">
        <i class="fas fa-exclamation-triangle"></i>
        Modulo no implementado. Contactar a soporte: <?php echo htmlspecialchars(sistema_admin_support_email(), ENT_QUOTES, 'UTF-8'); ?>
    </div>
    <?php endif; ?>
    ...
    <div class="stats-grid av-stats av-mobile-tab-content" data-mobile-tab="resumen">
        <div class="stat-card">
            ...
            <div class="stat-content"><h3><?php echo $contadores['presentes']; ?></h3><p>Presentes</p></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon warning"><i class="fas fa-clock"></i></div>
            <div class="stat-content"><h3><?php echo $contadores['tardanzas']; ?></h3><p>Tardanzas</p></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon info"><i class="fas fa-adjust"></i></div>
            <div class="stat-content"><h3><?php echo $contadores['media_falta']; ?></h3><p>Media falta</p></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon primary"><i class="fas fa-file-medical"></i></div>
            <div class="stat-content"><h3><?php echo $contadores['aus_justificados']; ?></h3><p>Justificados</p></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon danger"><i class="fas fa-user-times"></i></div>
            <div class="stat-content"><h3><?php echo $contadores['ausentes']; ?></h3><p>Ausentes</p></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon neutral"><i class="fas fa-users"></i></div>
            <div class="stat-content"><h3><?php echo count($filasAsistencia); ?></h3><p>Total</p></div>
        </div>
    </div>
    <?php endif; ?>
            ...
            <form method="GET" class="form-container" id="av-filtros-form">
                ...
                <div class="form-group" id="grupo_taller_filter_container" style="display: <?php echo $materiaEsTaller ? '' : 'none'; ?>;">
                    ...
                    <select id="grupo_taller" name="grupo_taller" <?php echo $materiaEsTaller ? 'required' : ''; ?>>
                        ...
                        <option value="A" <?php echo $grupoTallerSeleccionado === 'A' ? 'selected' : ''; ?>>Grupo A</option>
                        <option value="B" <?php echo $grupoTallerSeleccionado === 'B' ? 'selected' : ''; ?>>Grupo B</option>
                        <option value="C" <?php echo $grupoTallerSeleccionado === 'C' ? 'selected' : ''; ?>>Grupo C</option>
                        <option value="D" <?php echo $grupoTallerSeleccionado === 'D' ? 'selected' : ''; ?>>Grupo D</option>
                        <option value="E" <?php echo $grupoTallerSeleccionado === 'E' ? 'selected' : ''; ?>>Grupo E</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="estudiante_id">Buscar alumno</label>
                ...
                <div class="form-group">
                    <label for="trimestre">Cuatrimestre</label>
                    <select id="trimestre" name="trimestre">
                        <option value="" <?php echo $trimestreSeleccionado === '' ? 'selected' : ''; ?>>Ciclo lectivo</option>
                        <option value="1" <?php echo $trimestreSeleccionado === '1' ? 'selected' : ''; ?>>1er cuatrimestre</option>
                        <option value="2" <?php echo $trimestreSeleccionado === '2' ? 'selected' : ''; ?>>2do cuatrimestre</option>
                    </select>
                </div>
                <div class="form-group">
    ...
    <div class="card av-mobile-tab-content" data-mobile-tab="alumnos">
        <div class="card-header av-header-toma">
            <div>
                <h3 class="card-title"><i class="fas fa-clipboard-list"></i> Toma de asistencia</h3>
        ...
        <div class="card-body">
            <p class="text-muted"><i class="fas fa-info-circle"></i> No hay alumnos activos en este curso.</p>
        </div>
        <?php else: ?>
        <form method="POST" class="form-container" enctype="multipart/form-data" id="form-asistencia">
            ...
            <div class="av-search-bar-container">
                <div class="av-search-wrapper">
                    ...
                    <input type="text" id="av-search-input" class="av-search-input" placeholder="Buscar estudiante por nombre, apellido o DNI..." autocomplete="off">
                </div>
            </div>
            ...
            <?php foreach ($filasAsistencia as $i => $alumno):
                ...
                $pctLabel   = $pct < 0 ? 'Sin datos' : number_format($pct, 1) . '%';
            ...
            ?>
            <div class="av-student-card <?php echo $esSolapado ? 'av-student-card--solapada' : ''; ?> av-card-status-<?php echo $statusLower; ?>" 
                ...
                <div class="av-card-header">
                    <div class="av-card-info">
                        ...
                        <div class="av-card-name-section">
                            ...
                            <?php if ($esRecursante): ?>
                                <span class="badge badge-warning badge-recursante">Recursante</span>
                            <?php endif; ?>
                            <span class="av-mobile-status-badge">
                                <?php echo $estadoActual !== '' ? htmlspecialchars($estadosConfig[$estadoActual]['label'], ENT_QUOTES, 'UTF-8') : 'Sin marcar'; ?>
                            </span>
                        </div>
                    </div>
                    <div class="av-card-header-actions">
                        <span class="av-pct <?php echo $pctClase; ?>" data-eid="<?php echo $eid; ?>"><?php echo $pctLabel; ?></span>
                        <a class="btn-ficha" href="estudiante_ficha.php?id=<?php echo $eid; ?>" title="Ver ficha">
                            <i class="fas fa-chevron-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="av-card-details" id="details-<?php echo $eid; ?>" style="display: none;">
                    <div class="av-card-details-fields">
                        <div class="av-details-field-obs">
                            <label for="obs-<?php echo $eid; ?>"><i class="far fa-edit"></i> Observación</label>
                            <?php if ($puedeEditar): ?>
                            <input type="text"
                                   id="obs-<?php echo $eid; ?>"
                        ...
                        <div class="av-details-field-file">
                            <label><i class="fas fa-paperclip"></i> Justificativo</label>
                            <div class="av-file-uploader-row">
                                ...
                                <label class="av-file-label" title="Adjuntar justificativo (JPG, PNG, PDF — máx. 5MB)">
                                    <input type="file"
                                           ...
                                           class="av-file-input">
                                    <span class="av-file-btn"><i class="fas fa-upload"></i> Subir</span>
                                </label>
                                <?php endif; ?>
                                ...
                                <div class="av-file-status-wrapper">
                                    ...
                                    <?php else: ?>
                                    <span class="av-no-file-text text-muted">Sin archivo</span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                ...
                <div class="av-card-footer">
                    <button type="button" class="av-toggle-details-btn" data-eid="<?php echo $eid; ?>">
                        <span class="btn-text">Ver notas y justificativo</span>
            ...
            <div class="av-floating-status-bar" id="av-status-bar">
                <div class="av-status-progress">
                    ...
                    <span>Toma: <strong id="av-progress-count">0/0</strong> (<strong id="av-progress-percent">0%</strong>)</span>
                </div>
                <div class="av-status-saver" id="av-status-saver">
                    <i class="fas fa-check-circle"></i>
                    <span id="av-status-text">Guardado</span>
                </div>
            </div>

            <?php if (!$puedeEditar): ?>
            <div class="alert alert-info" style="margin:1rem 1.5rem;">
                <i class="fas fa-eye"></i> Vista de solo lectura.
            </div>
            <?php endif; ?>
        ...
        <div class="av-bottom-sheet-content">
            ...
            <div class="av-bottom-sheet-body">
                ...
                <div class="av-sheet-section">
                    <label class="av-sheet-section-title">Registrar Asistencia</label>
                ...
                <div class="av-sheet-section">
                    ...
                    <div class="av-sheet-file-row">
                        <label class="av-sheet-file-uploader" title="Adjuntar justificativo">
                            ...
                            <span class="av-sheet-file-btn"><i class="fas fa-upload"></i> Subir Archivo</span>
                        </label>
            ...
            <div class="av-bottom-sheet-footer">
                <button type="button" class="btn btn-primary w-100" id="av-sheet-save-btn">Listo</button>
            </div>
        </div>
    </div>
    ...
    <div class="card av-mobile-tab-content" data-mobile-tab="alumnos">
        <div class="card-body">
            <p class="text-muted"><i class="fas fa-info-circle"></i> Seleccioná una materia para registrar o visualizar asistencia.</p>
        </div>
    </div>
    <?php endif; ?>
