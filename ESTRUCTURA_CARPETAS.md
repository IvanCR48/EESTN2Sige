...
- **`estudiantes.php`** - Gestión y listado de estudiantes
- **`estudiante_ficha.php`** - Vista detallada de un estudiante individual
- **`profesores.php`** - Gestión y listado de profesores
- **`profesor_ficha.php`** - Vista detallada de un profesor individual
- **`cursos.php`** - Gestión de cursos académicos
- **`materias.php`** - Gestión de materias/asignaturas
- **`materias_previas.php`** - Gestión de correlatividades entre materias
- **`notas.php`** - Carga y gestión de calificaciones
- **`horarios.php`** - Gestión de horarios de clases
- **`llamados.php`** - Gestión de llamados de atención a estudiantes
- **`especialidades.php`** - Gestión de especialidades técnicas
- **`equipo.php`** - Gestión del equipo directivo y docente
...
### **database/sistema_admin_eest2.sql**
...
- **`estudiantes.php`** - Manual sobre el ABM de alumnos, ficha individual y visualización de legajos.
- **`profesores.php`** - Gestión de legajos docentes y su vinculación con materias.
