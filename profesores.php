...
<section class="profesores-section">
    <div class="section-header">
        <h2>
            ...
            <?php if ($curso_filter && !empty($curso_info_etiqueta)): ?>
                    <span style="font-size: 0.8em; color: var(--secondary-color); font-weight: normal;">
                        - Profesores de <?php echo htmlspecialchars((string) ($curso_info_etiqueta['anio'] ?? '') . '° ' . (string) ($curso_info_etiqueta['division'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>
    ...
    <div class="alert alert-info" style="margin-bottom: 1rem;">
        <i class="fas fa-info-circle"></i> Solo se muestran los preceptores del equipo directivo que comparten <strong>al menos un curso de trabajo</strong> con usted.
    </div>
    <?php endif; ?>
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <p><?php echo $modo_lista_preceptores_equipo ? 'Preceptores (su curso)' : 'Total Profesores'; ?></p>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <form method="POST" class="form-container">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select name="especialidad_id" id="especialidad_id">
                        ...
                        <?php foreach ($especialidades_formulario as $esp): ?>
                        <option value="<?php echo htmlspecialchars((string) $esp['id'], ENT_QUOTES, 'UTF-8'); ?>" 
                                <?php echo (string) $form_values['especialidad_id'] === (string) $esp['id'] ? 'selected' : ''; ?>>
                            <?php echo htmlspecialchars((string) ($esp['nombre'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="email">Email del docente (Google):</label>
                    <input type="email" name="email" id="email" maxlength="100"
                           placeholder="Ej: profesor@gmail.com"
                           value="<?php echo htmlspecialchars($form_values['email'], ENT_QUOTES, 'UTF-8'); ?>">
                    <small>Debe coincidir con la cuenta de Google que usará en «Continuar con Google» en el login.</small>
                </div>
                <div class="form-group">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Buscar preceptor</h3>
        </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="search" id="search" 
                           ...
                           placeholder="Apellido, nombre o usuario">
                </div>
            </div>
            <div class="form-actions">
                <button type="submit" class="btn btn-primary">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><?php echo $modo_lista_preceptores_equipo ? 'Preceptores del curso' : 'Profesores Registrados'; ?> (<?php echo number_format($total_profesores); ?>)</h3>
        </div>
                    ...
                    <?php if ($modo_lista_preceptores_equipo && !empty($preceptores_mismo_curso)): ?>
                        ...
                        <tr>
                            <td>
                                ...
                                <br><span class="status status-info" style="font-size: 0.75rem;">Usted</span>
                                <?php endif; ?>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <span class="status status-warning" style="font-size: 0.75rem;">Sin usuario</span>
                                <?php endif; ?>
                            </td>
                            <td>
                    ...
                    <?php elseif (!$modo_lista_preceptores_equipo && !empty($profesores_data)): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <span class="status status-warning">Sin cursos asignados</span>
                                <?php endif; ?>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <?php if ($fid > 0): ?>
                                <a href="profesor_ficha.php?id=<?php echo $fid; ?>"
                        ...
                        <tr>
                            <td colspan="<?php echo $modo_lista_preceptores_equipo ? '4' : '6'; ?>" class="text-center" style="padding: 2rem; color: var(--secondary-color);">
                                ...
                                if ($modo_lista_preceptores_equipo) {
                                    ...
                                    echo 'No se encontraron profesores con los criterios especificados';
                                }
                                ?>
                                <?php if (!$modo_lista_preceptores_equipo): ?>
        ...
        <nav class="pagination-nav" aria-label="Paginación de profesores" style="display: flex; flex-wrap: wrap; align-items: center; justify-content: center; gap: 0.35rem; padding: 1rem 1rem 1.25rem; border-top: 1px solid var(--medium-gray, #e2e8f0);">
            ...
            $mk = static function (array $base, int $p): string {
                $base['page'] = $p;
                return 'profesores.php?' . http_build_query($base);
            };
            ?>
