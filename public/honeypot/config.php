...
echo "define('EMAIL_USER', 'admin@eest2.edu.ar');\n";
echo "define('EMAIL_PASS', 'email_password_123');\n";
echo "define('SLACK_WEBHOOK', 'https://hooks.slack.com/services/T00000000/B00000000/XXXXXXXXXXXXXXXXXXXXXXXX');\n";
echo "define('AWS_ACCESS_KEY', 'AKIAIOSFODNN7EXAMPLE');\n";
echo "define('AWS_SECRET_KEY', 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY');\n\n";
