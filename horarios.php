...
$pageTitle = 'Horarios - Sistema Administrativo E.E.S.T N°2';
...
<section class="horarios-section">
    ...
    <div class="alert alert-info horarios-alert-preceptor">
        <i class="fas fa-info-circle"></i> Vista docente: solo sus horarios en los cursos donde tiene materias asignadas.
    </div>
    <?php elseif ($preceptor_cids !== []): ?>
    <div class="alert alert-info horarios-alert-preceptor">
        <i class="fas fa-info-circle"></i> Vista de preceptor: solo horarios de sus cursos
    ...
    <div class="section-header">
        ...
        <div class="header-actions">
            ...
            >
                <i class="fas fa-sliders-h"></i> Configurar bloques
            </button>
    ...
    <?php if (!$formularios_ok): ?>
        <div class="alert alert-warning">
            ...
            Formulario de datos no disponible.
            <?php if ($debug_error_formulario): ?>
                <br><strong style="color: #dc2626;">Error: <?php echo htmlspecialchars($debug_error_formulario); ?></strong>
            <?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <div class="card horarios-bloques-card<?php echo $accionBloquesMensaje ? '' : ' is-collapsed'; ?>" id="horarios-bloques-card">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-clock"></i> Configurar Bloques Horarios (Inicio / Fin)</h3>
        </div>
            ...
            <form method="POST" class="form-container horarios-bloques-add-form">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="nueva_hora">Agregar nueva hora</label>
        ...
        <form method="POST" class="form-container">
            ...
            <div class="form-row">
                ...
                <div class="form-group" id="grupo_taller_container_edit" style="display: none;">
                    <label for="grupo_taller_edit">Grupo de Taller: *</label>
                    <select name="grupo_taller" id="grupo_taller_edit">
                        <option value="">Seleccionar grupo</option>
                        <option value="A" <?php echo ($horario_editar['grupo_taller'] ?? '') === 'A' ? 'selected' : ''; ?>>Grupo A</option>
                        <option value="B" <?php echo ($horario_editar['grupo_taller'] ?? '') === 'B' ? 'selected' : ''; ?>>Grupo B</option>
                        <option value="C" <?php echo ($horario_editar['grupo_taller'] ?? '') === 'C' ? 'selected' : ''; ?>>Grupo C</option>
                        <option value="D" <?php echo ($horario_editar['grupo_taller'] ?? '') === 'D' ? 'selected' : ''; ?>>Grupo D</option>
                        <option value="E" <?php echo ($horario_editar['grupo_taller'] ?? '') === 'E' ? 'selected' : ''; ?>>Grupo E</option>
                    </select>
                </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="profesor_id_edit">Docente:</label>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Horarios Registrados (<?php echo number_format($total_horarios, 0, ',', '.'); ?>)</h3>
        </div>
                ...
                <div class="horarios-grid-layout">
                    ...
                    <div class="horarios-sub-section">
                        <h5 class="horarios-sub-title">
                            <i class="fas fa-calendar-alt"></i> Horario General
                        </h5>

                        <?php if (empty($bloque['filas'])): ?>
                            <div class="horarios-no-data">
                                <i class="fas fa-info-circle"></i> No hay horarios de materias comunes registrados para este curso.
                            </div>
                        <?php else: ?>
                                                    ...
                                                    <div class="materia-cell">
                                                        <div class="horario-bloque-tramo">
                                                                ...
                                                                <?php if (!empty($h['docente'])): ?>
                                                                    ...
                                                                    <?php if (($h['suplencia_estado'] ?? '') === 'activa'): ?>
                                                                        <?php if (!empty($h['fuera_servicio'])): ?>
                                                                            <div class="horario-tramo-meta"><span class="status status-danger status-chip-xs"><i class="fas fa-ban"></i> Fuera de Servicio</span></div>
                                                                        <?php else: ?>
                                                                            <div class="horario-tramo-meta"><span class="status status-warning status-chip-xs"><i class="fas fa-user-clock"></i> Suplente: <?php echo htmlspecialchars(trim((string) (($h['suplente_apellido'] ?? '') . ' ' . ($h['suplente_nombre'] ?? ''))), ENT_QUOTES, 'UTF-8'); ?></span></div>
                                                                        <?php endif; ?>
                                                                    <?php endif; ?>
                                                                <?php else: ?>
                                                                    <div class="horario-tramo-meta"><span class="status status-danger status-chip-xs">Sin profesor</span></div>
                                                                <?php endif; ?>
                                                            </div>
                                                            ...
                                                            <div class="horario-tramo-fin">
                                                                ...
                                                                <span class="horario-tramo-fin-label">Fin del módulo</span>
                                                            </div>
                                                        </div>

                                                        <?php if ($servicioAutenticacion->tienePermiso('gestionar_horarios')): ?>
                                                        <div class="horario-tramo-acciones">
                                                            <a href="horarios.php?action=editar&amp;id=<?php echo (int) $h['id']; ?>"
                    ...
                    <div class="horarios-sub-section horarios-taller-section">
                        <h5 class="horarios-sub-title">
                            <i class="fas fa-tools"></i> Horario de Taller
                        </h5>
                        ...
                        <div class="horarios-tabs-nav">
                            ...
                            <?php foreach ($bloque['grupos_taller'] as $grupo => $filasTaller): ?>
                                <button type="button"
                                        ...
                                        data-tab-target="taller-<?php echo htmlspecialchars($grupo, ENT_QUOTES, 'UTF-8'); ?>-<?php echo $cursoIndex; ?>">
                                    Grupo <?php echo htmlspecialchars($grupo, ENT_QUOTES, 'UTF-8'); ?>
                                </button>
    ...
    <div class="card">
        <div class="card-body text-center horarios-empty-body">
            ...
            <h3 class="horarios-empty-title">No hay horarios registrados</h3>
...
?>
<script nonce="<?php echo $horariosNonce; ?>">window.__HORARIOS_PAGE__ = <?php echo $horariosPageJson; ?>;</script>
